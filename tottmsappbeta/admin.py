...
from .models import Forms, SchoolLevel, Region, District, School, Subject, SalaryScale, WorkerGrade,Teacher
...
class TeacherAdmin(admin.ModelAdmin):
    list_display = ('id','fname','mname','sname','check_number','position','username','gender','start_date','date_of_birth','expected_retirement_date','region','district','school_level','school','education_level','subjects_taught','phone','email','password','created_at','updated_at')
    search_fields = ('id','fname','mname','sname','check_number','position','username','gender','start_date','date_of_birth','expected_retirement_date','region','district','school_level','school','education_level','subjects_taught','phone','email','password','created_at','updated_at')
    list_filter =('id','fname','mname','sname','check_number','position','username','gender','start_date','date_of_birth','expected_retirement_date','region','district','school_level','school','education_level','subjects_taught','phone','email','password','created_at','updated_at')
